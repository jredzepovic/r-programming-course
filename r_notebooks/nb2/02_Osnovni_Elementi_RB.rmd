...
if (100 %% 2 == 0) print("Uspjeh!")
```

***


Već smo spomenuli da R nudi dva operatora pridruživanja, `<-` i `=`. Pogledajmo ima li očitih razlika između njih.


### Zadatak 2.7 - operatori pridruživanja

```{r}
# stvorite varijable x i y i objema dodijelite broj 5, jednoj sa operatorom <-, 
# drugoj sa operatorom =
# ispišite varijable na zaslon
# uočavate li razliku između ova dva operatora?
x <- 5
y = 5
x
y
...
### Zadatak 2.8 - ime varijable sa specijalnim znakovima
...
### Zadatak 2.9 - ispis i brisanje varijabli globalne okoline
...
### Zadatak 2.10 - rad sa NA, NaN i NULL
...
### Zadatak 2.11 - provjera nedostajućih vrijednosti
